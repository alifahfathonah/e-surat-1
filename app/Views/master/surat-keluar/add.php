            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-info">
                        ...
                        <form action="<?= base_url('tambah-surat-masuk/save') ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="perihal" class="form-control <?= ($validation->hasError('perihal')) ? 'is-invalid' : ''; ?>" rows="3" autocomplete="off" placeholder="Tulis Perihal ..."><?= old('perihal'); ?></textarea>
                                    <span class="error invalid-feedback"> <?= $validation->getError('perihal'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label>Asal Surat<span class="text-danger">*</span></label>
                                    <input name="asal" type="text" class="form-control <?= ($validation->hasError('asal')) ? 'is-invalid' : ''; ?>" autocomplete="off" value="<?= old('asal'); ?>">
